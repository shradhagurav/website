...
const Footer = () => {
  return (
    <div>
<div class="footer-2 bg-gray-800 pt-6 md:pt-12 mt-8">
  <div class="container px-4 mx-auto">

    <div class="md:flex md:flex-wrap md:-mx-4 py-6 md:pb-12">

      <div class="footer-info lg:w-1/3 md:px-4">
        <h4 class="text-white text-2xl mb-4">19K users are using BrickFolio and making their life easy.</h4>
        ...
        <div class="mt-4">
          ...
          <button class="bg-twitter py-2 px-4 text-white rounded ml-2 mt-2 transition-colors duration-300">
            <span class="fab fa-twitter mr-2"></span> Follow @brickfolio
          </button>
        </div>
      </div>
      ...
      <div class="md:w-1/3 md:px-4 md:text-center mt-12 lg:mt-0">
        ...
        <button class="bg-gray-200 text-black hover:bg-gray-200 rounded py-2 px-6 md:px-12 transition-colors duration-300">Explore</button>
      </div>
    ...
    <div class="container px-4 mx-auto">
      ...
      <div class="md:flex md:-mx-4 md:items-center">
        <div class="md:flex-1 md:px-4 text-center md:text-left">
          <p class="text-white">&copy; <strong>Brickfolio</strong></p>
        </div>
